...
tags: ['Javascript']
draft: false
summary: 本文介绍了优雅编写 JavaScript 代码的方法，包括避免使用糟粕特性、编写简洁代码（如使用有意义变量名等）、利用 ES6/ES7 新特性（箭头函数等）、使用 Babel 转码、ESLint 保证代码风格、Prettier 格式化代码、采用函数式编程等，强调长期奉行这些准则能提升代码质量，是软件工程发展的重要部分。 
---
