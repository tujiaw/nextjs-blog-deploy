...
tags: ['Life']
draft: false
summary: 文章讲述字符编码故事，从 ASCII 到 GB2312 等多种编码，后 ISO 制定 UNICODE 统一所有字符，UTF 标准用于网络传输。还介绍了 Ansi、Unicode、UTF8 字符串特点及相互转换代码，如 Ansi 转 Unicode 用 MultiByteToWideChar 等函数，UTF8 转 Unicode 用 WideCharToMultiByte 等函数。  
---
